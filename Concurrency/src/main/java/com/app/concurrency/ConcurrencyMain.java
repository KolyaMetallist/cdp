...
public class ConcurrencyMain {
    ...
    public static void main( String[] args ) throws InterruptedException {
    	...
    	for(int i = 0; i < 10; i++) {
	    	...
	    	//Arrays.stream(values2).forEach(a -> System.out.print(a + " "));
	    	System.out.println(cores + " threads. Elapsed time: " + elapsedTime + " ms\n");
	    	...
	    	arraySize *= 2; // Enlarge the array size
    	}
    }
    ...
    public static int getSortThreads(int length) {
    	// decided to use core count in the case of parallel approach. Link http://faculty.ycp.edu/~dhovemey/spring2011/cs365/lecture/lecture18.html
    	int cores = length <  THRESHOLD ? 1
