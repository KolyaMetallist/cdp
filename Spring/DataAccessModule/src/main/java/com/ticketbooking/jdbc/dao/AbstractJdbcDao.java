...
public abstract class AbstractJdbcDao<E extends Entity> implements Dao<E> {
	...
	protected static final String SELECT_TICKET_BY_USER = "SELECT * FROM TICKET WHERE USER_ID = ?";
	protected static final String SELECT_TICKET_BY_EVENT = "SELECT * FROM TICKET WHERE EVENT_ID = ?";
